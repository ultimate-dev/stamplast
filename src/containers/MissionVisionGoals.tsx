        ...
        <div className="md:w-1/3 p-3" data-aos="fade-up">
          ...
          >
            ...
            <div className="text-center text-gray-500 text-sm mt-3 pt-3 border-t border-gray-100">
              ...
              üretimi ve buna bağlı sistemlerde geliştirmek ve bununla birlikte
              iş hacmini büyütmek.
            </div>
          </motion.div>
        </div>
        <div className="md:w-1/3 p-3" data-aos="fade-up">
          ...
          >
            ...
            <div className="text-center text-gray-500 text-sm mt-3 pt-3 border-t border-gray-100">
              ...
              ürünü zamanında teslim ederek müşteri memnuniyetini ön planda
              tutmak ve rekabetçi olmak.
            </div>
          </motion.div>
        </div>
        <div className="md:w-1/3 p-3" data-aos="fade-up">
